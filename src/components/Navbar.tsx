...
const Navbar = () => {
  ...
  return <nav className={`bg-primary backdrop-blur border-b border-primary-foreground/20 sticky top-0 z-50 transition-transform duration-300 ${isVisible ? "translate-y-0" : "-translate-y-full"}`}>
